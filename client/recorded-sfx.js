...
export const RECORDED_CUES={
 ...
 'guard-impact':pool('shield-guard',.72,.72),
 'block-impact':pool('shield-impact-3 shield-impact-4',.72,.95),
 'parry-impact':pool('shield-impact-4 shield-impact-3',.82,1.15,1.06),
 'reflect-impact':pool('shield-impact-3 shield-impact-4',.76,1.2,.92),
 'counter-impact':pool('shield-impact-4 shield-impact-3',.88,1.3,.86),
